class Recipe < ApplicationRecord
  ...
  accepts_nested_attributes_for :hops, reject_if: proc { |attributes| attributes['name'].blank? }, allow_destroy: true
  ...
  accepts_nested_attributes_for :brewing_salts, reject_if: proc { |attributes| attributes['name'].blank? }, allow_destroy: true

  has_many :miscs, inverse_of: :recipe
